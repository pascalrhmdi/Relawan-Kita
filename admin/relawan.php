...
$query = $pdo->query('SELECT COUNT(id_pengguna) as id FROM pengguna WHERE role = "volunteer"');
$row = $query->fetch();
// total row
$total = $row['id'];
...
// semua data diambil
$results = $crud->getUsersLimit($awalData, $menampilkanDataPerHalaman);
...
<head>
    ...
    <title>Manajemen Relawan | Relawan Kita</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Manajemen Relawan</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header">
                            <h6 class="m-0 font-weight-bold text-primary py-2">List Relawan</h6>
                        </div>
                        <div class="card-body">

                            <h6>Total User Relawan : <?= $total; ?></h6>
                                        ...
                                        <tbody class="text-center">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        <a href="edit-relawan.php?id=<?= $r['id_pengguna'] ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
                                                        <a onclick="return confirm('Are you sure you want to delete this record?');" href="../functions/delete-user.php?id=<?= $r['id_pengguna'] ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            endwhile ?>
