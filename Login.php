...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!$result) {
        ...
        else if ($_SESSION['role'] == 'organisasi') header("Location: Admin-Acara.php?login=success");
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
            <div class="p-2 m-1 mb-3 border">
                ...
                <div class="d-flex justify-content-evenly">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="login" id="volunteer" value="volunteer"
                            checked>
            ...
            <div class="input-group mb-4">
                ...
                <input type="email" class="form-control" placeholder="Email" id="email" name="email"
                    aria-describedby="basic-addon1" data-bs-toggle="tooltip" data-bs-placement="right"
                    title="Email harus valid"
                    value="<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') echo $_POST['email']; ?>" required autofocus>
            </div>
            <!-- Password -->
            <div class="input-group mb-3">
                ...
                <input type="password" class="form-control" placeholder="Password" id="password" name="password"
                    data-bs-toggle="tooltip" data-bs-placement="right" title="Masukkan Password"
