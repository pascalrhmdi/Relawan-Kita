    ...
    <div class="col-4">
        ...
        <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="post">
            ...
            <div class="input-group mb-4">
                ...
                <input type="email" class="form-control" placeholder="Email" id="email" name="email" aria-describedby="basic-addon1" data-bs-toggle="tooltip" data-bs-placement="right" title="Email harus valid" value="<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') echo $_POST['email']; ?>" required autofocus>
            </div>
            <!-- Password -->
