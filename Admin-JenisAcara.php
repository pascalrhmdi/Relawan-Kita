<?php
     ...
     // semua data diambil
     $results = $crud->getJenisAcara($awalData, $menampilkanDataPerHalaman);
...
<div class="d-flex justify-content-end mb-2">
     <div class="col-3">
          <form action="insert-jenis-acara.php" method="POST">
               <input type="text" class="form-control" id="nama_jenis_acara" placeholder="Nama Jenis Acara" name="nama_jenis_acara" maxlength='50' required > 
     </div>
     <div class="col-1">
               <div class="d-grid ">
               ...
               <tbody>
                    ...
                    <tr>
                         ...
                         <td class="d-flex justify-content-around" >
                              <a href="edit.php?id=<?= $r['id_jenis_acara'] ?>" class="btn btn-warning" style="width:100%; max-width: 100px">Edit</a>
                              <a onclick="return confirm('Are you sure you want to delete this record?');" href="delete-jenis-acara.php?id=<?= $r['id_jenis_acara'] ?>" class="btn btn-danger" style="width:100%; max-width: 100px">
