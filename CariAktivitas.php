...
if (isset($_GET['judul_acara'])) {
    ...
    $results = $crud->getAcaraFiltered($awalData, $menampilkanDataPerHalaman, $judul_acara, $organisasi, $lokasi, $nama_jenis_acara);
} else {
    // ambil total ketika gak di filter
...
<div class="d-flex justify-content-between text-danger mb-2">
    <h3 class="align-self-start mb-0">Cari Aktivitas Baru,<span class="fs-4 fw-normal"> <?= $total; ?> Aktivitas
            Membutuhkan Bantuan Anda</span></h3>
    <!-- Toggle Filter -->
    <a class="btn btn-danger text-white" data-bs-toggle="collapse" href="#filter" role="button" aria-expanded="false"
...
<div class="collapse my-3" id="filter">
    <div class="card card-body shadow-sm p-3 bg-body rounded">
        ...
        <form method="GET" action="" autocomplete="on" class="row g-2 ">
            ...
            <div class="col-2">
                <input type="text" class="form-control" name="nama_jenis_acara" placeholder="Jenis Acara"
                    maxlength='255'>
            </div>
            <div class="col-2">
        ...
        <div class="card shadow-sm" style="height: 100%;">
            <a href="ViewAktivitas.php?id_acara=<?= $r['id_acara'] ?>" rel="noopener noreferrer" class="no-effect-link">
                ...
                <div class="card-body ">
                    ...
                    <span class="text-uppercase p-1 rounded-pill"
                        style="border: 1px solid #DF202E; color:#DF202E; font-size: 8px"><?= $r['nama_jenis_acara']; ?></span>
