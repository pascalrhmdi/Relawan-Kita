<?php
     ...
     // semua data diambil
     $results = $crud->getOrganisasi($awalData, $menampilkanDataPerHalaman);
          ...
          <table class="table table-striped table-bordered">
               ...
               <tbody>
                    ...
                    <tr>
                         ...
                         <td style="max-width: 210px;"><?= is_null($r['nama_organisasi']) ? '-' : $r["nama_organisasi"] ; ?></td>
                         <td style="max-width: 600px;"><?= is_null($r['deskripsi_organisasi']) ? '-' : $r["deskripsi_organisasi"] ; ?></td>
                         <td><?= is_null($r['tahun_berdiri']) ? '-' : $r["tahun_berdiri"] ; ?></td>
                         <td class="d-grid gap-2">
                              <a href="edit.php?id=<?= $r['id_organisasi'] ?>" class="btn btn-warning btn-block" style="width:100%">Edit</a>
                              <a onclick="return confirm('Are you sure you want to delete this record?');" href="delete-organisasi.php?id=<?= $r['id_organisasi'] ?>" class="btn btn-danger" style="width:100%">Delete</a>
                         </td>
                    </tr>
                    <?php $i++; endwhile ?>
               </tbody>
